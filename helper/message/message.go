...
var ErrInvalidDateRange = Message{Code: 34602, Message: "start date is greater than end date"}
var ErrDateRangeGreaterThanAllowed = Message{Code: 34602, Message: "date range is greater than allowed"}
